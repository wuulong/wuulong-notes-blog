...
graph TD;
    ...
    %% 新店溪與南勢溪系統
    B2_2[內洞國家森林遊樂區 (南勢溪源)] --> B2_1[碧潭與青潭水源地 (新店溪)];
    B2_1 --> C;
    
    %% 基隆河系統
    B3_2[平溪煤礦/十分瀑布 (基隆河源)] --> B3_1[員山子分洪道 (基隆河分流)];
    B3_1 --> B;
```
...
| --- | --- | --- | --- |
| **海口故事** | 水筆仔紅樹林、感潮帶底棲生物（招潮蟹、彈塗魚）、大批候鳥。 | 關渡自然保留區、淡水河紅樹林保護區。 | 河口垃圾堆積、河水感潮污染、紅樹林擴張淤積。 |
| **都會脈動** | 城市河濱綠帶、泥灘地水鳥（鷺鷥科、鷸鴴科）。 | 社子島濕地。 | 高牆堤防阻絕人水關係、污水排放。 |
...
1. **防洪設施卡片檢視**：`Generate a comparison card layout comparing dadaocheng water gates, shezi flood wall, and yuanshanzi diversion channel focusing on engineering type and construction year.`
2. **森林與水源生態面板**：`Create a summary dashboard highlighting Nei-dong, Man-yue-yuan, and Dong-yan-shan forests including hiking duration, river basin, and ecological warning level.`
