...
series: ["2026台灣河流探索"]
tags: ["田野敲敲門", "逆向閱讀", "Gemini", "Deep Research", "知識轉譯"]
...
最近，我購買了《田野敲敲門 2：調查研究再進攻》這本書。在實體書寄達之前，我決定進行一場 **「逆向閱讀實驗 (Inverse Reading Experiment)」**：如果我能利用 AI，在讀書前就建構出這本書的知識地圖，甚至先寫出一本「預習專書」，那翻閱原書的過程，是否會從「學習」轉化為「高品質的對話」？
...
首先，我讓 AI 擷取 Readmoo 官網上的公開資訊——目錄、作者簡介、序言。這就像是先在地圖上標註出「大比例尺」的邊界，確認這場冒險的基本範疇。
...
### 4. 預習專書產製 (Synthesis)
最後，在實體書寄到前，我和 AI 共同撰寫了一本 **「Pre-book」**。這本專書包含了七章正文與實務附錄（Checklist、術語表、引用圖譜）。
...
現在的我，對於書中提到的「安琪、梅君、伯邑」等人的筆法與關懷已如數家珍。當我翻開實體書的那一刻，我不再是一個學生，而是一個帶著「預演地圖」與作者們在河邊會合的「對話者」。
